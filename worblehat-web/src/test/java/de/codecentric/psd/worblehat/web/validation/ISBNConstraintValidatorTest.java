...
public class ISBNConstraintValidatorTest {
    ...
    @Test
    public void shouldReturnTrueFor13DigitIfvalidISBN() throws Exception {
        boolean actual = isbnConstraintValidator.isValid("01234597892X", constraintValidatorContext);
        assertFalse(actual);
    }
